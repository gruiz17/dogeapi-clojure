...
(with-test
  ...
  (is (= (:body (http/get (str api-url "&a=get_my_addresses"))) (dogeapi-clojure.core/get-my-addresses wow)))
  ...
  (is (= (json/read-json (:body (http/get (str api-url2 "&a=get_my_addresses")))) (dogeapi-clojure.core/get-my-addresses wow2)))
